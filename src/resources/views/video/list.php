        ...
        <div class="pull-right">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <a class="js-ajax js-delete-warning" href="<?=URL::to('admin').'/video/items/delete?model='.Input::get('model').'&model_id='.Input::get('model_id').'&part='.Input::get('part')?>">Удалить все</a>
                    </li>
                </ul>
            </div>
        </div>
