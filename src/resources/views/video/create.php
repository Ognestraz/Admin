    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="js-ajax" action="<?=URL::to('/')."/admin/video".($video->id ? '/'.$video->id : '')?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12">                    
                            ...
                            <a href="<?=URL::to('/admin')."/video"?>" class="js-ajax btn btn-danger" data-target="#page-wrapper">Отмена</a>
                        </div>
                    </div>
                </form>
            </div>
