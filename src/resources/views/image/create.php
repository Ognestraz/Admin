<form class="js-ajax" action="<?=URL::to('/')."/admin/image".($image->id ? '/'.$image->id : '')?>" method="POST" enctype="multipart/form-data"> 
        ...
        <div class="col-lg-7">
            <div id="tabs" class="js-tabs">
                <ul class="nav nav-tabs js-tabs">
                    <li class="active"><a href="#sub-tabs-5" data-url="<?=URL::to('/admin').'/image/'.$image->id.'/edit?variant=original'?>" data-toggle="tab">Оригинал</a></li>
                    <li><a href="#sub-tabs-5" data-url="<?=URL::to('/admin').'/image/'.$image->id.'/edit?variant=icon'?>" data-toggle="tab">Icon</a></li>
                    <li><a href="#sub-tabs-5" data-url="<?=URL::to('/admin').'/image/'.$image->id.'/edit?variant=preview'?>" data-toggle="tab">Preview</a></li>
                    <li><a href="#sub-tabs-5" data-url="<?=URL::to('/admin').'/image/'.$image->id.'/edit?variant=large'?>" data-toggle="tab">Large</a></li>
                </ul>
