<li data-id="<?=$video->id?>" class="list-group-item item">
    ...
    <?=$video->name?>
    <a href="<?=URL::to('/')?>/admin/video/act/<?=$video->id?>" class="act ajax">
        <img src="<?=URL::to('/')?>/assets/images/checkbox_<?=($video->act ? 'full' : 'empty')?>.png">
    </a>
    <a href="<?=URL::to('/')?>/admin/video/<?=$video->id?>/edit" class="edit ajax-modal" data-target="#subModal">
        <img src="<?=URL::to('/')?>/assets/images/edit.png">
    </a>
    <a href="<?=URL::to('/')?>/admin/video/<?=$video->id?>" class="ajax delete">
