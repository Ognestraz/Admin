    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="<?=URL::to('/admin')."/file"?>" class="js-ajax" data-target="#page-wrapper">Документы и файлы</a> / 
                <?=(($file->id) ? 'Редактирование: ' . $file->name : 'Добавление')?>                
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form class="js-ajax" action="<?=URL::to('/')."/admin/file".($file->id ? '/'.$file->id : '')?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12">                    
                            ...
                            <a href="<?=URL::to('/admin')."/file"?>" class="js-ajax btn btn-danger" data-target="#page-wrapper">Отмена</a>
                        </div>
                    </div>
