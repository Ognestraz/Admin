    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="js-ajax" action="<?=URL::to('/')."/admin/menu".($menu->id ? '/'.$menu->id : '')?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-12">                    
                            ...
                            <a href="<?=URL::to('/admin')."/menu"?>" class="js-ajax btn btn-danger" data-target="#page-wrapper">Отмена</a>
                        </div>
                    </div>
