    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="<?=URL::to('/admin')."/site"?>" class="js-ajax" data-target="#page-wrapper">Страница</a> / 
                <?=(($site->id) ? 'Редактирование: ' . $site->name : 'Добавление')?>                
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form class="js-ajax" action="<?=URL::to('/')."/admin/site".($site->id ? '/'.$site->id : '')?>" method="POST">
                        ...
                        <ul class="nav nav-tabs js-tabs">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#tab-site" data-url="<?=URL::to('/').'/admin/image/upload?model=site&model_id=' . $site->id . '&part=main&view=list'?>" data-toggle="tab">Главная</a></li>
                                    <li><a href="#tab-site" data-url="<?=URL::to('/').'/admin/image/upload?model=site&model_id=' . $site->id . '&part=album&view=list'?>" data-toggle="tab">Альбом</a></li>
                                    <li><a href="#tab-site" data-url="<?=URL::to('/').'/admin/image/upload?model=site&model_id=' . $site->id . '&part=content&view=list'?>" data-toggle="tab">Контент</a></li> 
                                </ul>             
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Видео<span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#tab-site" data-url="<?=URL::to('/').'/admin/video/upload?model=site&model_id=' . $site->id . '&part=main&view=list'?>" data-toggle="tab">Главная</a></li>
                                    <li><a href="#tab-site" data-url="<?=URL::to('/').'/admin/video/upload?model=site&model_id=' . $site->id . '&part=album&view=list'?>" data-toggle="tab">Альбом</a></li>
                                    <li><a href="#tab-site" data-url="<?=URL::to('/').'/admin/video/upload?model=site&model_id=' . $site->id . '&part=content&view=list'?>" data-toggle="tab">Контент</a></li> 
                                </ul>             
                            </li>
                            <li><a href="<?=URL::to('/').'/admin/site/settings/'.$site->id?>" data-toggle="tab">Настройки</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-site-content">
                                <div class="row">
                                    <div class="col-lg-12">                            
                                        <div class="form-group">
                                            <a href="<?=URL::to('/')?>/admin/image/upload?module=site&module_id=<?=$site->id?>&part=content&view=list-content" class="ajax-modal" data-target="#subModal">
                    ...
                    <div class="row">
                        <div class="col-lg-12">                    
                            ...
                            <a href="<?=URL::to('/admin')."/site"?>" class="js-ajax btn btn-danger" data-target="#page-wrapper">Отмена</a>
                        </div>
                    </div>                       
