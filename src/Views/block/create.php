    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="js-ajax auto-validation2" action="<?=URL::to('/')."/admin/block".($block->id ? '/'.$block->id : '')?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-12">                    
                            ...
                            <a href="<?=URL::to('/admin')."/block"?>" class="js-ajax btn btn-danger" data-target="#page-wrapper">Отмена</a>
                        </div>
                    </div>                    
